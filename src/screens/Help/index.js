      ...
      <Card>
        ...
        <CardSection>
          <Text style={main}>
            ...
            интересе; в случае несогласия с этими условиями пользователь должен
            ...
            установки приложения, изменённые пользователем, непосредственно на
            устройстве пользователя. Для определения локальных данных
            пользователя, с целью персонализации предоставляемых сервисов по
            стране нахождения пользователя, возможно незначительное
            использование интернет трафика. Настоящая Политика применима только
            к программному коду Banoka. Banoka не контролирует и не несет
            ответственность за программный код третьих лиц.
          </Text>
        </CardSection>
      </Card>
      <Card>
        ...
        <CardSection>
          <Text style={main}>
            ...
            бесперебойной работы приложения, соответствия содержимого приложения
